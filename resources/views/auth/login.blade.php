...
<div class="mx-auto xs:w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 auth-form rounded-sm px-10 py-4 my-20">
    <form method="post">
        ...
        <h1 class="my-2 font-bold text-xl text-blue-500">Log In into {{ config('app.name') }}</h1>
        ...
        <div class="my-3">
            ...
            <div class="my-2 mb-4 flex items-center justify-between" style="margin-top: -4px">
                ...
                <div>
                    <a href="#" class="transition font-bold text-sm text-blue-500 hover:text-blue-600">Forgot password?</a>
                </div>
            </div>
    ...
    <div class="mt-4 mb-2 flex justify-center">
        ...
        <a href="/join" class="transition font-bold text-sm text-blue-500 hover:text-blue-600">Join</a>
    </div>
</div>
@stop