...
<div class="border border-gray-200 mx-auto xs:w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 auth-form rounded-sm px-10 py-4 my-20">
        ...
        <div class="my-3">
            <div class="grid place-items-center my-4">
                ...
                <label class="cursor-pointer mt-6">
                    <span class="mt-2 leading-normal px-4 py-2 bg-{{ $mainColor }}-200 hover:bg-{{ $mainColor }}-300 transition text-{{ $mainColor }}-500 text-sm rounded-sm">Select Image</span>
            ...
            <select class="border border-gray-200 w-full p-3 mb-6 font-bold text-sm placeholder-gray-600 text-gray-600 rounded-sm appearance-none focus:shadow-outline" name="role">
    ...
    <div class="mt-4 mb-2 flex justify-center">
        <p class="font-bold text-sm text-gray-600">Already a member?</p>&nbsp;
        <a href="/login" class="transition font-bold text-sm text-{{ $mainColor }}-400 hover:text-{{ $mainColor }}-500">Log In</a>
    </div>
</div>
