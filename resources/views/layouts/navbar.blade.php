<div class="border-b border-gray dark:bg-gray-800">
    <div class="px-2 sm:px-4 h-14 flex justify-between container mx-auto lg:max-w-5xl">
        ...
        <div class="flex space-x-8">
            ...
            >My Orders</a>
            <a
                class="hidden sm:block transition bg-current-100 hover:bg-current-200 text-current-600 dark:bg-current-800 dark:hover:bg-current-900 dark:text-current-300 p-2 px-4 self-center text-xs font-bold rounded-sm"
                href="{{ route('login') }}"
            >Log In</a>
        </div>
    </div>
