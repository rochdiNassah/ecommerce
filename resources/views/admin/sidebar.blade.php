...
<div class="transition border-r border-gray-500 h-screen bg-gray-800 lg:left-0 fixed lg:relative w-full sm:w-80 hidden lg:block z-10" id="dashboard-sidebar">
    ...
    <ul class="grid">
        <a class="transition p-2 px-8 border-b border-gray-500 bg-gray-700 hover:bg-gray-600" href="{{ route('users') }}">
            <li class="transition text-gray-300 hover:text-gray-100 text-lg">Users</li>
        </a>

        <a class="transition p-2 px-8 border-b border-gray-500 bg-gray-700 hover:bg-gray-600" href="{{ route('products') }}">
            <li class="transition text-gray-300 hover:text-gray-100 text-lg">Products</li>
        </a>

        <a class="transition p-2 px-8 border-b border-gray-500 bg-gray-700 hover:bg-gray-600" href="{{ route('account') }}">
            <li class="transition text-gray-300 hover:text-gray-100 text-lg">My Account</li>
        </a>

        @if ('dashboard' !== Route::current()->uri)
        <a class="transition p-2 px-8 border-b border-gray-500 bg-gray-700 hover:bg-gray-600" href="{{ route('dashboard') }}">
    ...
    <div class="border-t border-gray-500 bottom-0 left-0 p-4 px-8 absolute w-full">
        <a href="{{ route('logout') }}"><div class="w-full text-sm text-red-300 bg-red-700 hover:bg-red-600 transition rounded-sm p-2 text-center font-bold">Log Out</div></a>
    </div>
</div>
