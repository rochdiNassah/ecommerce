    ...
    <div class="flex">
        ...
        <div class="grid place-items-center w-full">
            <div class="p-4 w-full lg:w-4/5 xl:w-3/5 grid grid-cols-1 sm:grid-cols-2 gap-4 h-screen place-items-center">
                <div class="h-80 w-full relative rounded-sm border border-gray">
                    <div class="border-b border-gray py-4 text-center text-gray-600 text-xl font-bold">Users</div>
                ...
                <div class="h-80 w-full relative rounded-sm border border-gray">
                    <div class="border-b border-gray py-4 text-center text-gray-600 text-xl font-bold">Products</div>
